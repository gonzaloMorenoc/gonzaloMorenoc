...
<p align="left">
  <img src="https://img.shields.io/badge/ISTQB-CTFL-orange?style=flat-square" />
  <img src="https://img.shields.io/badge/ISTQB-CT--TAS%20(Automation%20Specialist)-orange?style=flat-square" />
  <img src="https://img.shields.io/badge/ISTQB-CT--MAT%20(Model--Based%20Testing)-orange?style=flat-square" />
  <img src="https://img.shields.io/badge/ISTQB-CT--GenAI%20(Generative%20AI%20Testing)-orange?style=flat-square" />
</p>
...
![TestNG](https://img.shields.io/badge/TestNG-DD0031?style=flat-square)
...
| **[CazaRelojes · cazarelojes.com](https://cazarelojes.com)** | Watch-buying assistant for the Spanish market. You declare a purchase mission (reference, target price, conditions) and it watches a verifiable set of sources, alerting on Telegram with the **real landed cost** — customs, shipping and pending servicing — instead of the listing price. Append-only history, no LLM in the decision path, and silence as the default state | `Python` `Next.js` `Supabase` `GitHub Actions` `Telegram` |
